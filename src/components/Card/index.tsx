        ...
        <div className={styles.cardContainer}>
            <Link href={`/imovel`}><a href="/imovel">
                <header>
                    ...
                    <Link href={`#`}><a href="#"><img className={styles.icons} src="/air-bnb-small.png" alt="Air BNB" /></a></Link>
                    <Link href={`#`}><a href="#"><img className={styles.icons} src="/seazone-small.png" alt="Seazone" /></a></Link>
                </header>
